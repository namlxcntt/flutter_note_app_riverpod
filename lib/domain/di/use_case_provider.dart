...
import 'package:flutter_note_app/domain/detail/update_note_use_case.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

import '../../data/di/data_provider.dart';

final createNoteUseCaseProvider = Provider((ref) {
  final noteRepository = ref.read(createNoteRepoProvider);
...
final updateNoteUseCaseProvider = Provider((ref) {
  final noteRepository = ref.read(createNoteRepoProvider);
  var updateNoteUseCase = UpdateNoteUseCase(noteRepository);
